/*
* Arduino RFID project. Allows RFID keys to be programmed using a master RFID Tag and store the keys in EEPROM to allow for keeping the keys between power cycles. 
*                
...
uint8_t R1getID() /////////////////////////// RECOGNIZE, READ, CONVERT, AND STORE RFID UID FOR LATER USE /////////////////////////////
{
...
uint8_t R2getID() /////////////////////////// RECOGNIZE, READ, CONVERT, AND STORE RFID UID FOR LATER USE /////////////////////////////
{
  // Getting ready for Reading PICCs
  if (( ! R2.PICC_IsNewCardPresent()) ||  ( ! R2.PICC_ReadCardSerial()))   
    {              //If a new PICC placed to RFID reader continue
